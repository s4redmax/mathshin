...
local function nextpage13()
        storyboard.gotoScene( "page5", "crossFade", 1000 )    
    return true
end

local function nextpage14()
        storyboard.gotoScene( "page5", "crossFade", 1000 )    
    return true
end

local function nextpage15()
        storyboard.gotoScene( "page5", "crossFade", 1000 )    
    return true
end
