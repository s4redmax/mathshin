...
local function nextpage16()
        storyboard.gotoScene( "home", "crossFade", 1000 )    
    return true
end

local function nextpage17()
        storyboard.gotoScene( "home", "crossFade", 1000 )    
    return true
end

local function nextpage18()
        storyboard.gotoScene( "home", "crossFade", 1000 )    
    return true
end
